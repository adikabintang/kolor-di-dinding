...
# Runtime: 76 ms, faster than 9.23% of Python3 online submissions (-_-)
# Memory Usage: 14 MB, less than 100.00% of Python3 online submissions
# time complexity: O(m * n), m = sizeof array words, n = size of word in words
# space complexity: O(m + n), m = size of S, n = size of word in words
class Solution:
